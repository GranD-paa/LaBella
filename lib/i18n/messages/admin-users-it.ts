export const adminUsersIt = {
  ...
  listCapped: "Mostrati {shown} di {total} utenti. Cerca per trovare gli altri.",
  listCappedFiltered: "Mostrati {shown} di {total} risultati. Affina la ricerca per vedere gli altri.",
  columnUser: "Utente",
  columnEmail: "Email",
  columnStatus: "Stato",
  columnRole: "Ruolo",
