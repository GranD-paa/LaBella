...
export const it: Messages = {
  ...
  auth: {
    ...
    region: "Da dove ti registri?",
    regionIran: "Dall'Iran",
    regionAbroad: "Fuori dall'Iran",
    regionHint: "Gli account in Iran si confermano via SMS; da ogni altro paese inviamo un link per email.",
    phone: "Numero di cellulare",
    phonePlaceholder: "09121234567",
    phoneIntlPlaceholder: "+39 320 1234567",
    phoneHint: "Se sei fuori dall'Iran, includi il prefisso internazionale.",
  ...
  actions: {
    errors: {
      ...
      iranPhoneRequired: "Hai scelto l'Iran, quindi il numero deve essere un cellulare iraniano.",
