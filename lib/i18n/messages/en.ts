...
export const en = {
  ...
  auth: {
    ...
    region: "Where are you signing up from?",
    regionIran: "Inside Iran",
    regionAbroad: "Outside Iran",
    regionHint: "Accounts inside Iran are confirmed by SMS; from anywhere else we send an email link instead.",
    phone: "Mobile number",
    phonePlaceholder: "09121234567",
    phoneIntlPlaceholder: "+49 151 23456789",
    phoneHint: "Include your country code if you are outside Iran.",
  ...
  actions: {
    errors: {
      ...
      iranPhoneRequired: "You chose Iran, so the number must be an Iranian mobile.",
