...
export const en = {
  ...
  auth: {
    ...
    phoneGateTitle: "Sign in / Sign up",
    phoneGateSubtitle: "Enter your mobile number and we will text you a one-time code.",
    phoneGateHint: "If you already have an account you will be signed in; if not, one is created.",
    continue: "Continue",
    codeSentTo: "A six-digit code was sent to {phone}.",
    codeLabel: "Verification code",
    codeHint: "The code is valid for 2 minutes.",
    wrongNumber: "Wrong number?",
    resend: "Send the code again",
    resendIn: "Resend in {seconds}s",
    welcomeTitle: "Welcome",
    welcomeSubtitle: "A few short things, just this once.",
    firstName: "First name",
    lastName: "Last name",
    nameLatinHint: "Write your name in English letters — this is what goes on the certificate and the videos.",
    birthDate: "Date of birth",
    birthYear: "Year",
    birthMonth: "Month",
    birthDay: "Day",
    emailReceiptsHint: "Receipts and notices go here. No need to confirm it.",
    finish: "Let's go",
    ...
    validation: {
      codeDigits: "The code is six digits",
      firstNameMin: "First name must be at least 2 letters",
      firstNameMax: "First name is too long",
      lastNameMin: "Last name must be at least 2 letters",
      lastNameMax: "Last name is too long",
      nameLatin: "Use English letters only",
      birthDateRequired: "Complete your date of birth",
      birthDateReal: "That day does not exist in this month",
      birthYearRange: "Check the year",
      birthYearFuture: "That year has not happened yet",
      ...
      phoneIran: "Enter an Iranian mobile number — accounts are confirmed by SMS.",
  ...
  dashboard: {
    ...
    admin: {
      ...
      monitoringHint: "Overview of student activity and performance.",
      ...
      outOfTotalQuizzes: "Out of {count} total quizzes",
      avgScore: "Avg. score",
  ...
  dev: {
    banner: "Local development mode — in-memory fixture data, no SMS. Sign in with {adminPhone} (admin) or {userPhone} (learner) and code {code}.",
  },
  admin: {
    tabs: {
      lessons: "Lessons",
  ...
  meta: {
    ...
    welcome: "Finish your account — Laparli",
  ...
  actions: {
    errors: {
      ...
      confirmPhone: "We sent a code to your phone. Enter it to finish signing up.",
      invalidPhone: "That phone number does not look right.",
      iranPhoneRequired: "Sign-up needs an Iranian mobile number — that is where the code is sent.",
      tooManyCodes: "Too many codes requested for this number. Try again in a few hours.",
      accountSuspended: "Your account has been suspended. Contact support.",
      challengeFailed: "The security check did not finish. Refresh the page and try again.",
      codeTooSoon: "A code was just sent. Give it a moment.",
      tooManyFromHere: "Too many requests from this connection. Try again shortly.",
      tooManyAttempts: "Too many wrong codes. Try again in an hour.",
      smsUnavailable: "We could not send a text just now. Try again in a few minutes.",
      codeInvalid: "The code must be six digits.",
      codeWrong: "That code is wrong or has expired.",
      emailTaken: "That email is already on another account. Use a different one.",
      localModeUnknownPhone: "Local development only knows the seeded numbers. Try 09121111111 (admin) or 09122222222 (learner) with code 000000.",
