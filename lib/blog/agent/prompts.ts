...
معیار امروز گوگل «این صفحه سؤال کاربر را بهتر از بقیه جواب می‌دهد؟» است، نه «چند بار کلیدواژه تکرار شده». پس:
...
معیار تشخیص: اگر همان تصویر به درد ده مقاله‌ی دیگر هم می‌خورد، تصویر اشتباهی است.
